...
| 項目 | 配分 |
|------|------|
| 四種模型 Pipeline 建立正確 | 10 分 |
| cross_val_score 使用正確，5 折結果完整 | 10 分 |
| 印出平均分數與標準差 | 10 分 |
| 視覺化比較且找出最佳模型 | 10 分 |
...
| 項目 | 配分 |
|------|------|
| Pipeline 與參數搜尋空間定義正確 | 10 分 |
| GridSearchCV 執行成功 | 10 分 |
| 最佳參數與分數正確 | 10 分 |
| 前 5 名與 Classification Report 完整 | 10 分 |
...
| 項目 | 配分 |
|------|------|
| Q1 正確說明交叉驗證的優勢與單次切割的問題 | 7 分 |
| Q2 正確解釋 cv 意義並計算總訓練次數 | 7 分 |
| Q3 正確說明 C 值的影響與過擬合/欠擬合的關係 | 6 分 |
